...
def extract_feats(args,h5_file_path,wsi,slide_path,model,output_path,target_roi_size=2048,patch_size=256,levels=[0,1,2],batch_size=1,is_stain_norm=False):
    ...
    roi_dataloader = DataLoader(roi_dataset,batch_size=batch_size,num_workers=20)
    # first w
    mode = 'w'
...
parser.add_argument('--data_h5_dir', type=str, default='/mnt/data3/Pathology/ROAM-main/pathches')
parser.add_argument('--data_slide_dir', type=str, default='/mnt/data2/data/CCRCC')
parser.add_argument('--csv_path', type=str, default='/mnt/data3/Pathology/ROAM-main/data_prepare/data_csv/example_xiangya_data_info_pro.csv')
parser.add_argument('--dataset', type=str, default='TCGA')
parser.add_argument('--data_format', type=str, default='roi',choices=['roi','patch'])
parser.add_argument('--feat_dir', type=str, default = '/mnt/data3/Pathology/ROAM-main/features/imagenet')
...
parser.add_argument('--is_stain_norm',action='store_true',default=True,help='whether stain normlization')
